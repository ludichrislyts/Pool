...
-- --------------------------------------------------
-- Date Created: 02/20/2016 16:17:27
-- Generated from EDMX file: C:\Users\Aaron Campf\Documents\GitHub\Pool - CE Test\MvcApplication1\Models\Database.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_PlaceStaticReview]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Reviews] DROP CONSTRAINT [FK_PlaceStaticReview];
GO
...
IF OBJECT_ID(N'[dbo].[FK_UserStaticReview]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Reviews] DROP CONSTRAINT [FK_UserStaticReview];
GO
